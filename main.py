...
from service import (
    get_productos, get_producto_by_id, create_producto, update_producto,
    delete_producto, cambiar_estado_producto,
    recomendar_productos, filtrar_productos,
    get_tipos_piel, buscar_tipo_piel, create_tipo_piel, update_tipo_piel, delete_tipo_piel,
    get_categorias, buscar_categoria, create_categoria, update_categoria, delete_categoria,
)
...
app = FastAPI(title="Beauty App", lifespan=lifespan)
